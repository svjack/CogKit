...
# FIXME: removes unnecessary params, refer to FLUX
# @click.option(
#     "--height",
#     type=click.IntRange(min=1),
...
@click.option(
    ...
    type=click.IntRange(min=1),
    default=50,
    help="the number of the diffusion steps",
)
# @click.option(
#     "--guidance_scale",
#     # TODO: range?
#     type=float,
#     # default=6.0,
#     help="the classifier-free guidance scale defined in the paper `Classifier-Free Diffusion Guidance`",
# )
...
def inference(
    ...
    - save_file (str | Path): The path where the generated image or video will be saved.
